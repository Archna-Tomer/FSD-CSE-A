...
function ImageManipulation() {
  ...
  return (
    <div style={{height:'400px',width:'400px', border:'4px solid green',marginLeft:'50px',marginTop:'100px'}}>
        <div style={{paddingLeft:'100px',paddingTop:'20px',width:'300px',backgroundColor:`RGB(${red},${blue},${green})`}}>
        <img src={coffee} alt="" height={height} width={width} style={{rotate:`${rotate}deg`}} />
